...
class RedBlackTree:
    def __init__(self):
        self.head = None
        self.size = 0
        self.min = RedBlackTree.RedBlackNode(self, None)
        self.max = RedBlackTree.RedBlackNode(self, None)
    ...
    def insert(self, v):
        ...
        if self.head is None:
            self.head = RedBlackTree.RedBlackNode(self, v)
    ...
    class RedBlackNode:
        ...
        def insert(self, value):
            if value < self.value:
                if self.left is not None:
                    ...
                    self.left = RedBlackTree.RedBlackNode(self, value)
                ...
                if self.right is not None:
                    ...
                    self.right = RedBlackTree.RedBlackNode(self, value)
        ...
        def print_tree(self, indent=0, blacks_seen=0):
            ...
            print("{}{}-{} Node, Value={}".format("|  " * indent, side, self.color, self.value) + nils_check)
            if self.left is not None:
